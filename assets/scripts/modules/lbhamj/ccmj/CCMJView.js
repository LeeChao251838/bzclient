...
cc.Class({
    ...
    initHander() {
        ...
        game.addHandler('push_dingzhuang_ctc', function (data) {
            console.log("==>> push_dingzhuang_ctc --> data: ", data);
            self.dingZhuang(data);
        });

        game.addHandler('dingzhuang_result_push_ctc', function (data) {
            console.log("==>> dingzhuang_result_push_ctc --> data: ", data);
            self.dingZhuangResult(data);
        });
    ...
    initView() {
        ...
        cc.fy.utils.addClickEvent(this._canCancelTing, this.node, 'CCMJView', 'cancelTingClick');
    ...
    onGameBegin() {
        ...
        if (cc.fy.ccmjMsg.otherHasAction) {
            this.showOtherHasAction();
            cc.fy.ccmjMsg.otherHasAction = false;
        }
