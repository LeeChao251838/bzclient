cc.Class({
    ...
    initHandlers:function()
    {
        ...
        cc.fy.gameMsg.addHandler("game_Zhongmapai_push", function(data){
            console.log("==>> game_Zhongmapai_push: ", data);
            cc.fy.hzmjMsg.maimapais = data.maiMaPai;
            cc.fy.hzmjMsg.zhongmapais = data.zhongMa;
        });
