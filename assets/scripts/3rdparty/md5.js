var md5 = cc.Class({
    ...
    statics: {
       ...
       hex_md5:function(s){ return md5.binl2hex(md5.core_md5(md5.str2binl(s), s.length * md5.chrsz));},
       b64_md5:function(s){ return md5.binl2b64(md5.core_md5(md5.str2binl(s), s.length * md5.chrsz));},
       hex_hmac_md5:function(key, data) { return md5.binl2hex(md5.core_hmac_md5(key, data)); },
       b64_hmac_md5:function(key, data) { return md5.binl2b64(md5.core_hmac_md5(key, data)); },
       calcMD5:function(s){ return md5.binl2hex(md5.core_md5(md5.str2binl(s), s.length * md5.chrsz));},
