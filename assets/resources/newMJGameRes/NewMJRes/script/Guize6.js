cc.Class({
    ...
    initData(obj) {
        ...
        if (conf.renshu) {
            ...
            this.wanfa4[0].getChildByName('Label').getComponent(cc.Label).string = conf.renshu+'人'
        }
        if (conf.baseScore) {
            ...
            this.wanfa5[0].getChildByName('Label').getComponent(cc.Label).string = conf.baseScore+'分'
        }
        if(cc.fy.gameNetMgr.conf.isClubRoom){
            ...
            this.node.getChildByName('bg').height = 330
        }
